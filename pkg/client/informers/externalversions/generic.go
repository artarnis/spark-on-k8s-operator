...
import (
	...
	v1beta1 "github.com/artarnis/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1beta1"
	v1beta2 "github.com/artarnis/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1beta2"
